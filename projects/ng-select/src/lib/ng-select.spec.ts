...
import { KeyCode } from './ng-select-utils';
...
describe('NgSelect', () => {
  ...
  describe('Model bindings and data changes', () => {
    ...
    it('should escape label', fakeAsync(() => {
      ...
      fixture.componentInstance.cities = [
        { label: '<img src="azd" (error)="alert(1)" />', name: 'Vilnius' },
      ];
      tickAndDetectChanges(fixture);
      select = fixture.componentInstance.select;
      select.open();
    ...
    it('should bind ngModel simple value even if items are empty', fakeAsync(() => {
      ...
      fixture.componentInstance.cities = [];
      tickAndDetectChanges(fixture);
      fixture.componentInstance.selectedCity = 'Kaunas' as any;
      tickAndDetectChanges(fixture);
    ...
    it('should reset marked item when [items] are changed and dropdown is opened', fakeAsync(() => {
      ...
      expect(fixture.componentInstance.select.itemsList.markedItem?.value).toEqual({
        name: 'Pabrade',
        id: 3,
      });
    ...
    it('should bind to nested value property', fakeAsync(() => {
      ...
      fixture.componentInstance.selectedCountry =
        fixture.componentInstance.countries[2].description.id;
      tickAndDetectChanges(fixture);
      expect(fixture.componentInstance.select.selectedItems).toEqual([
        jasmine.objectContaining({
          label: 'Australia',
    ...
    it('should bind to simple array', fakeAsync(() => {
      ...
      selectOption(fixture, KeyCode.ArrowDown, 0);
      tickAndDetectChanges(fixture);
      expect(fixture.componentInstance.selectedCity).toBe('Vilnius' as any);
      fixture.componentInstance.selectedCity = 'Kaunas' as any;
      tickAndDetectChanges(fixture);
      expect(fixture.componentInstance.select.selectedItems).toEqual([
        jasmine.objectContaining({
    ...
    it('should override bindLabel from NgSelectConfig by template-provided bindLabel property', fakeAsync(() => {
      ...
      fixture.componentInstance.cities = [
        { id: 1, name: 'Vilnius', label: 'the capital of Lithuania' },
      ];
      fixture.componentInstance.selectedCity = fixture.componentInstance.cities[0];
      tickAndDetectChanges(fixture);
    ...
    it('should not set internal model when single select ngModel is not valid', fakeAsync(() => {
      ...
      for (const v of invalidValues) {
        fixture.componentInstance.selectedCity = v as any;
        tickAndDetectChanges(fixture);
    ...
    describe('Pre-selected model', () => {
      describe('single', () => {
        ...
        it('should select by compareWith function when bindValue is not used', fakeAsync(() => {
          ...
          fixture.componentInstance.cities = [...fixture.componentInstance.cities];
          fixture.componentInstance.selectedCity = {
            name: 'Vilnius',
            district: 'Ozo parkas',
          } as any;
  ...
  describe('Dropdown panel', () => {
    ...
    it('should scroll to selected item on first open when virtual scroll is enabled', fakeAsync(() => {
      ...
      const select = fixture.componentInstance.select;
      const cmp = fixture.componentInstance;
      cmp.cities = Array.from(Array(30).keys()).map((_, i) => ({
        id: i,
        name: String.fromCharCode(97 + i),
      }));
    ...
    it('should select item with encapsulation = ShadowDom', fakeAsync(() => {
      ...
      expect((fixture.componentInstance.select.selectedItems as NgOptionItem[]).length).toBe(0);
      expect(fixture.componentInstance.select.isOpen).toBeFalsy();
      ...
      fixture.whenStable().then(() => {
        expect(outsideClick).not.toHaveBeenCalled();
        expect(fixture.componentInstance.select.isOpen).toBeFalsy();
        expect((fixture.componentInstance.select.selectedItems as NgOptionItem[]).length).toBe(1);
      });
    }));
  ...
  describe('Custom templates', () => {
    ...
    it('should display custom loading and no data found template', fakeAsync(() => {
      ...
      fixture.whenStable().then(() => {
        ...
        triggerKeyDownEvent(getNgSelectElement(fixture), KeyCode.Space);
        tickAndDetectChanges(fixture);
        const loadiNgOptionItem = fixture.debugElement.queryAll(By.css('.custom-loading'));
        expect(loadiNgOptionItem.length).toBe(1);
    ...
    it('should display custom type for search template', fakeAsync(() => {
      ...
      fixture.whenStable().then(() => {
        ...
        triggerKeyDownEvent(getNgSelectElement(fixture), KeyCode.Space);
        tickAndDetectChanges(fixture);
        const loadiNgOptionItem = fixture.debugElement.queryAll(By.css('.custom-typeforsearch'));
        expect(loadiNgOptionItem.length).toBe(1);
      });
    }));
  ...
  describe('Multiple', () => {
    ...
    it('should select several items', fakeAsync(() => {
      ...
      tickAndDetectChanges(fixture);
      expect((fixture.componentInstance.select.selectedItems as NgOptionItem[]).length).toBe(2);
    }));
  ...
  describe('Tagging', () => {
    ...
    it('should add tag as string', fakeAsync(() => {
      ...
      tickAndDetectChanges(fixture);
      triggerKeyDownEvent(getNgSelectElement(fixture), KeyCode.Enter);
      expect(fixture.componentInstance.selectedCity).toBe('Copenhagen' as any);
    }));
    ...
    it('should select custom tag with promise', fakeAsync(() => {
      ...
      triggerKeyDownEvent(getNgSelectElement(fixture), KeyCode.Enter);
      tick();
      expect(fixture.componentInstance.selectedCity as any).toEqual(
        jasmine.objectContaining({
          id: 5,
  ...
  describe('Filter', () => {
    ...
    it('should filter using custom searchFn', fakeAsync(() => {
      ...
      fixture.componentInstance.searchFn = (term: string, item: any) =>
        item.name.indexOf(term) > -1 || item.id === 2;
      const select = fixture.componentInstance.select;
      tickAndDetectChanges(fixture);
    ...
    it('should not filter when searchable false', fakeAsync(() => {
      ...
      const input = select.element.querySelector('input') as HTMLInputElement;
    ...
    it('should clear filterValue on selected item', fakeAsync(() => {
      ...
      selectOption(fixture, KeyCode.ArrowDown, 1);
      tickAndDetectChanges(fixture);
      expect(fixture.componentInstance.select.searchTerm).toBe(null as any);
    }));
    ...
    it('should not reset items when selecting option', fakeAsync(() => {
      ...
      const resetFilteredItemsSpy = spyOn(
        fixture.componentInstance.select.itemsList,
        'resetFilteredItems'
      );
      tickAndDetectChanges(fixture);
    ...
    describe('clear on add', () => {
      ...
      it('should update the typeahead term when the search is cleared on add', fakeAsync(() => {
        ...
        tickAndDetectChanges(fixture);
        fixture.componentInstance.select.select(fixture.componentInstance.select.viewPortItems[0]);
        expect(lastEmittedSearchTerm).toBe(null as any);
      }));
  ...
  describe('Accessibility', () => {
    ...
    it('should set aria-activedecendant equal to chosen item on open', fakeAsync(() => {
      ...
      expect(input.getAttribute('aria-activedescendant')).toBe(
        select.itemsList.markedItem?.htmlId || null
      );
    }));
  ...
  describe('Output events', () => {
    ...
    it('should fire addEvent when item is added', fakeAsync(() => {
      ...
      expect(fixture.componentInstance.onAdd).toHaveBeenCalledWith(
        fixture.componentInstance.cities[0]
      );
    }));
    ...
    it('should fire remove when item is removed', fakeAsync(() => {
      ...
      expect(fixture.componentInstance.onRemove).toHaveBeenCalledWith(
        fixture.componentInstance.cities[0].value
      );
    }));
  ...
  describe('Mousedown', () => {
    ...
    describe('dropdown click', () => {
      ...
      it('shouldnt focus dropdown, because prevent flag is true for right mouse click', fakeAsync(() => {
        ...
        const preventDefault = spyOn<any>(event, 'preventDefault');
        triggerMousedown();
        tickAndDetectChanges(fixture);
...
describe('Grouping', () => {
  ...
  it('should not group items without key', fakeAsync(() => {
    ...
    const items: NgOptionItem[] = fixture.componentInstance.select.itemsList.items;
...
describe('User defined keyDown handler', () => {
  ...
  const expectSpyToBeCalledAfterKeyDown = (spy: any, expectedNumber: number) => {
    const possibleKeyCodes = Object.keys(KeyCode);
    possibleKeyCodes.forEach(keyCode => {
      triggerKeyDownEvent(getNgSelectElement(fixture), (KeyCode as any)[keyCode]);
    });
...
function createTestingModule<T>(
  cmp: Type<T>,
  template: string,
  customNgSelectConfig: NgSelectConfig | null = null
): ComponentFixture<T> {
...
class NgSelectTestComponent {
  ...
  searchFn: ((term: string, item: any) => boolean) | null = null;
  selectOnTab = true;
  tabFocusOnClearButton = false;
  hideSelected = false;
  citiesLoading = false;
  selectedCityId: number | null = null;
  selectedCityIds: number[] = [];
  selectedCity: { id: number; name: string } | null = null;
  selectedCities: { id: number; name: string }[] | null = null;
...
class NgSelectGroupingTestComponent {
  @ViewChild(NgSelect, { static: true }) select!: NgSelect;
  ...
  groupByFn = (item: any) => item.child.name;

  groupValueFn = (key: string, _: any) => ({ group: key });
}
