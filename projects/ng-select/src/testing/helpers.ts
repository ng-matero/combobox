...
import { KeyCode } from '../lib/ng-select-utils';
...
export function selectOption(fixture: any, key: KeyCode, index: number) {
...
export function triggerKeyDownEvent(element: DebugElement, key: string, target?: Element): void {
